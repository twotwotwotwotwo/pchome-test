...
(function (jQuery, ytp) {
	...
	jQuery.mbYTPlayer = {
		...
		defaults        : {
			containment            : "body",
			ratio                  : "16/9",
			videoURL               : "http://youtu.be/IFjctYttwvY",
			startAt                : 0,
			stopAt                 : 0,
			autoPlay               : true,
			vol                    : 100, // 1 to 100
			addRaster              : false,
			opacity                : 1,
			quality                : "default", //or “small”, “medium”, “large”, “hd720”, “hd1080”, “highres”,"default"
			mute                   : false,
			loop                   : true,
			showControls           : false,
		...
		buildPlayer: function (options) {
			return this.each(function () {
               ...
               //// // // // // 高度//// // // // // 
				wrapper.css({position: "absolute", zIndex: 0, minWidth: "100%", minHeight: "660px", left: 0, top: 0, overflow: "hidden", opacity: 0,backgroundColor:"#000000"});
				...
				if (YTPlayer.isBackground) {
					jQuery("body").css({"position": "relative", "minWidth": "100%", "minHeight": "100%", "zindex": "1", "boxSizing": "border-box", "background-image": "url(img/bg00.jpg)", "background-size": "100% auto"});
