...
var IS_DEV = (document.location.href.match('ec1.my') == null) ? false : true ;
...
$(document)
    ...
    .on('_doRegister', function(e)
    {
        ...
        $.ajax({
             url: (IS_DEV) ? '//ecapi.ec1.mypchome.com.tw/marketing/order/v1/index.php/activity/'+strActId+'/prizeuid/'+strPrizeUid+'/register?memberid='+$.trim(getCookie('MBR')) 
                           : '//ecapi.pchome.com.tw/marketing/order/v1/index.php/activity/'+strActId+'/prizeuid/'+strPrizeUid+'/register?memberid='+$.trim(getCookie('MBR'))
    ...
    .on('click', '#Register', function()
    {
        ...
        else
        {
            ...
            $.ajax({
                 url : (IS_DEV) ? '//ecapi.ec1.mypchome.com.tw/marketing/order/v1/index.php/activity?id='+objAct.Id 
                                : '//ecapi.pchome.com.tw/marketing/order/v1/index.php/activity?id='+objAct.Id     //2.2.3
                ,dataType : 'jsonp'
                ,jsonp : '_callback'
            ...
            .done(function(arrAct)
            {
                ...
                if (objAct.Type == 'LuckyDraw' || intRemain > 0)
                {
                    ...
                    var strOptUrl = '/member/v2/member/islogin' ;

                    $.ajax({
                             url : (IS_DEV) ? '//ecapi.ec1.mypchome.com.tw/member/v2/member/islogin' 
                                            : '//ecapi.pchome.com.tw/member/v2/member/islogin'
                            ,dataType : 'jsonp'
                            ,jsonp : '_callback'
                    ...
                    .done(function(intRs)
                    {
                        ...
                        {
                            $.ajax({
                                 url : (IS_DEV) ? '//ecapi.ec1.mypchome.com.tw/marketing/order/v1/index.php/activity/'+objAct.Id+'/prizeuid/'+objAct.Prize[0].PrizeUid+'/register?memberid='+ $.trim(getCookie('MBR')) 
                                                : '//ecapi.pchome.com.tw/marketing/order/v1/index.php/activity/'+objAct.Id+'/prizeuid/'+objAct.Prize[0].PrizeUid+'/register?memberid='+ $.trim(getCookie('MBR')) 
                                ,dataType : 'jsonp'
                                ,jsonp : '_callback'
                        ...
                        else
                        {
                            ...
                            window.location.href = (IS_DEV) ? '//ecapi.ec1.mypchome.com.tw/login/v2/login.htm?rurl='+encodeURIComponent(strUrl) 
                                                            : '//ecapi.pchome.com.tw/login/v2/login.htm?rurl='+encodeURIComponent(strUrl) ;
                        }
                    }) ;
                }
                else
